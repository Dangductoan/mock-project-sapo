...
public class RevenueStatsController {
    ...
    public List<RevenueStats> getData_between(@PathVariable(value = "start") @DateTimeFormat(pattern = "yyyy-MM-dd") String start, @PathVariable(value = "end") @DateTimeFormat(pattern = "yyyy-MM-dd") String end) {
